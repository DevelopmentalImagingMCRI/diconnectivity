function [varargout] = diconn_genconnectome_python(Subject, MrtrixMethod, SeedType, Curvature, SeedSuffix, MrtrixSubjDir, MrtrixVersion, varargin)
...
while(NumTracksSoFar < TotalNumTracks)
	...
	switch(MrtrixVersion)
		case 2
			...
			fclose(FID);
			copyfile(LogFile, fullfile(MrtrixSubjDir, Subject, 'tmp.log'));
			delete(LogFile);
			clear LogFile;
			keyboard;
